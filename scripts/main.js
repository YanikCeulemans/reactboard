...
var React, SimpleComponent, SoundCard, TestComponent;
...
React.render(React.createElement(SoundCard, {
  "audiosrc": "/media/samples/kick.mp3"
}), document.getElementById('react-anchor'));



},{"./soundcard.coffee":159,"./test.coffee":160,"react":157}],159:[function(require,module,exports){
var Audier, HowlFactory, React, SoundCard;
...
Audier = (function() {
  ...
  Audier.prototype.load = function(url) {
    var request;
    ...
    request.onload = (function(_this) {
      return function() {
        return _this.context.decodeAudioData(request.response, function(buffer) {
          _this.loaded = true;
          return _this.audioBuffer = buffer;
        }, function(err) {
...
SoundCard = React.createClass({
  getInitialState: function() {
    return {
      ...
      howl: new HowlFactory.Howl({
        urls: [this.props.audiosrc]
      }),
      audier: new Audier(this.props.audiosrc)
    };
  },
  handleClick: function() {
    this.setState({
  ...
  render: function() {
    return React.createElement("div", {
      "className": "card-panel waves-effect soundcard",
      "onClick": this.handleClick
    }, "You clicked ", this.state.clickCount, " times.");
  }
});
...
},{"howler":2,"react":157}],160:[function(require,module,exports){
...
TestComponent = React.createClass({
  render: function() {
    return React.createElement("blockquote", null, "This is a simple test component");
  }
});
