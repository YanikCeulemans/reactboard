...
ContextMenu = React.createClass({
  ...
  render: function() {
    return React.createElement("div", null, React.createElement("div", {
      ...
      "href": "#!",
      "ref": "testref"
    }, "Bind key")), React.createElement("li", null, React.createElement("a", {
      "href": "#!"
    }, "two"))));
  }
});
...
var ContextMenu, React, SoundBoard, requestQ;
...
requestQ.get("/data/samples.json").then(function(response) {
  return React.render(React.createElement(SoundBoard, {
    "samples": response.data
  }), document.getElementById("react-anchor"));
}, function(err) {
  return console.log("error occurred while trying to fetch data: ", err);
});



},{"./contextMenu.coffee":162,"./soundboard.coffee":164,"./superagentQ.coffee":166,"react":158}],164:[function(require,module,exports){
var React, SoundBoard, SoundCard;
...
SoundBoard = React.createClass({
  ...
  render: function() {
    ...
    return React.createElement("div", {
      ...
      ref = this.props.samples;
      results = [];
      for (i = j = 0, len = ref.length; j < len; i = ++j) {
        sample = ref[i];
        results.push(React.createElement(SoundCard, {
          "key": i,
          "initialAudiosrc": sample.path,
          "name": sample.name
        }));
      }
      return results;
...
},{"./soundcard.coffee":165,"react":158}],165:[function(require,module,exports){
var ContextMenu, HowlFactory, React, SoundCard;
  ...
  getInitialState: function() {
    return {
      ...
      howl: new HowlFactory.Howl({
        urls: [this.props.initialAudiosrc]
      })
    };
  },
  handleClick: function() {
    ...
    return this.state.howl.play();
  },
  componentDidMount: function() {
    return console.log("componentDidMount", this.state);
  },
  render: function() {
    return React.createElement("div", {
      "className": "card waves-effect",
      "style": this.styles.soundcardStyles,
      "onClick": this.handleClick
    }, React.createElement("div", {
      "className": "card-image",
      "style": this.styles.topbarStyles
    }, React.createElement(ContextMenu, null)), React.createElement("div", {
...
},{"./contextMenu.coffee":162,"howler":2,"react":158}],166:[function(require,module,exports){
var Q, superagent;
